...
public class ReflectCacheUtil {
    ...
    public static List<FieldDetails> getExcelFieldList(Class cls) {
        return getFieldList(cls).stream().filter(obj -> ObjectUtil.isNotNull(obj.getExcel())).collect(Collectors.toList());
    }
}
