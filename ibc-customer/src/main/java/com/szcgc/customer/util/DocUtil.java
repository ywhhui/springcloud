...
public class DocUtil {
    ...
    public static void mergeCell(XWPFTable table, int beginRowIndex, int endRowIndex, int beginColIndex, int endColIndex) {
        ...
        for (int i = beginRowIndex; i <= endRowIndex; i++) {
            for (int j = beginColIndex; j <= endColIndex; j++) {
                XWPFTableCell cell = getCell(getRow(table, i), j);
     ...
     * @param content 内容
     */
    public static XmlCursor setText(XWPFDocument doc, XmlCursor cursor, String content) {
        return setText(doc, cursor, content, false, ParagraphAlignment.LEFT, 12);
    }
     ...
     * @param bold    是否加粗
     */
    public static XmlCursor setText(XWPFDocument doc, XmlCursor cursor, String content, boolean bold) {
        return setText(doc, cursor, content, bold, ParagraphAlignment.LEFT, 12);
    }
     ...
     * @param fontSize 文字大小
     */
    public static XmlCursor setText(XWPFDocument doc, XmlCursor cursor, String content, boolean bold, ParagraphAlignment align, int fontSize) {
